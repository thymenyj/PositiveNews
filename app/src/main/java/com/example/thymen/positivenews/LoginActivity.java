...
public class LoginActivity extends AppCompatActivity {
    public ImageView loginLogin, loginRegister;
    public EditText loginUsername, loginPassword;
    public TextView loginReset;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LoginActivity.this, InitialPreferenceActivity.class);
                startActivity(intent);
            }
        });
    }
        ...
        firebaseAuth.signInWithEmailAndPassword(username, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    Intent intent = new Intent(LoginActivity.this, PersonalFeedActivity.class);
                    startActivity(intent);
                }
                else {
